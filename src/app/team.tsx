    ...
    return (
        <div className="p-3 md:p-12 w-screen lg:p-20">
            <div className="flex flex-wrap justify-around">
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <a href="https://bagchi.github.io/" target="_blank" rel="noopener noreferrer">
                        <div className="drop-shadow-lg m-5 w-52 h-52">
                            <Image src='/saurabhbagchi.jpg' alt="Saurabh Bagchi" className="rounded-full object-cover" fill />
                        </div>
                    </a>
                    ...
                    <a className="rounded-full contact-button text-base mt-2 w-9 h-9 text-center place-self-center hover:bg-gray-300"
                        ...
                        <span className="grid h-full w-full place-content-center"><img src="/mail.svg" alt="Mail" /></span>
                    </a>
                </div>
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <a href="https://schaterji.io/" target="_blank" rel="noopener noreferrer">
                        <div className="drop-shadow-lg m-5 w-52 h-52">
                            <Image src='/somalichaterji.png' alt="Somali Chaterji" className="rounded-full object-cover" fill />
                        </div>
                    </a>
                ...
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <a href="https://www.purdue.edu/president/about/mung-chiang/" target="_blank" rel="noopener noreferrer">
                        <div className="drop-shadow-lg m-5 w-52 h-52">
                            <Image src='/mungchiang.jpg' alt="Mung Chiang" className="rounded-full object-cover" fill />
                        </div>
                    </a>
                ...
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <a href="https://kimkt.com/" target="_blank" rel="noopener noreferrer">
                        <div className="drop-shadow-lg m-5 w-52 h-52">
                            <Image src='/kwangtaikkim.jpg' alt="Kwang Taik Kim" className="rounded-full object-cover" fill />
                        </div>
                    </a>
                ...
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <a href="https://www.davidinouye.com/" target="_blank" rel="noopener noreferrer">
                        <div className="drop-shadow-lg m-5 w-52 h-52">
                            <Image src='/davidinouye.jpg' alt="David Inouye" className="rounded-full object-cover" fill />
                        </div>
                    </a>
                ...
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <a href="https://www.princeton.edu/~pmittal/" target="_blank" rel="noopener noreferrer">
                        <div className="drop-shadow-lg m-5 w-52 h-52">
                            <Image src='/prateekmittal.jpg' alt="Prateek Mittal" className="rounded-full object-cover" fill />
                        </div>
                    </a>
                ...
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <a href="https://www.biostat.wisc.edu/~yli/" target="_blank" rel="noopener noreferrer">
                        <div className="drop-shadow-lg m-5 w-52 h-52">
                            <Image src='/yinli.jpg' alt="Yin Li" className="rounded-full object-cover" fill />
                        </div>
                    </a>
            ...
            <div className="flex flex-wrap justify-around">
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <div className="drop-shadow-lg m-5 w-52 h-52">
                        <Image src='/pengwang.jpg' alt="Peng Wang" className="rounded-full object-cover" fill />
                    </div>
                    ...
                    <div className="flex flex-row place-content-center gap-2">
                        <a className="rounded-full contact-button text-base mt-2 w-9 h-9 text-center place-self-center hover:bg-gray-300"
                            ...
                            <span className="grid h-full w-full place-content-center"><img src="/user.svg" alt="User" /></span>
                        </a>
                    </div>
                </div>
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <div className="drop-shadow-lg m-5 w-52 h-52">
                        <Image src='/jameshare.jpg' alt="Zach Hare" className="rounded-full object-cover" fill />
                    </div>
                ...
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <div className="drop-shadow-lg m-5 w-52 h-52">
                        <Image src='/kevinchan.jpg' alt="Kevin Chan" className="rounded-full object-cover" fill />
                    </div>
