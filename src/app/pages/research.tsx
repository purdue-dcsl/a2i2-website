        ...
        <div className="p-6 pt-0 w-screen lg:p-24 lg:pt-0 md:p-12 md:pt-0">
            <div className="flex flex-wrap justify-around">
                <div className="grid flex-col w-96">
                    <Image src='/ancient-stone-column-dark.png' alt="" className="w-full" width={1080} height={1080} />
            ...
            <div className="flex flex-col mt-6">
                <div className="flex lg:flex-row flex-col-reverse">
                    ...
                    <Image src="/figure1.png" alt="Figure1" className="w-full lg:w-1/2 lg:m-4 object-contain" width={1080} height={1080} />
                </div>
            ...
            <div className="flex flex-col mt-6">
                <div className="flex lg:flex-row flex-col">
                    <Image src="/figure2.png" alt="Figure2" className="w-full lg:w-1/2 lg:m-4 object-contain" width={1080} height={1080} />
            ...
            <div className="flex flex-col mt-6">
                <div className="flex lg:flex-row flex-col-reverse">
                    ...
                    <Image src="/figure3.png" alt="Figure3" className="w-full lg:w-1/2 lg:m-4 object-contain" width={1080} height={1080} />
                </div>
