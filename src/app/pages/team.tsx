        ...
        <div className="p-3 md:p-12 w-screen lg:p-20">
            <div className="flex flex-wrap justify-around">
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <a href="https://bagchi.github.io/" target="_blank" rel="noopener noreferrer">
                        ...
                        <Image src='/pictures/saurabhbagchi.jpg' alt="Saurabh Bagchi" className="rounded-full object-cover drop-shadow-lg m-5 w-52 h-52" width={1080} height={1080} />
                    </a>
                ...
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <a href="https://schaterji.io/" target="_blank" rel="noopener noreferrer">
                        ...
                        <Image src='/pictures/somalichaterji.png' alt="Somali Chaterji" className="rounded-full object-cover drop-shadow-lg m-5 w-52 h-52" width={1080} height={1080} />
                    </a>
                ...
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <a href="https://www.purdue.edu/president/about/mung-chiang/" target="_blank" rel="noopener noreferrer">
                        ...
                        <Image src='/pictures/mungchiang.jpg' alt="Mung Chiang" className="rounded-full object-cover drop-shadow-lg m-5 w-52 h-52" width={1080} height={1080} />
                    </a >
                ...
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <a href="https://kimkt.com/" target="_blank" rel="noopener noreferrer">
                        ...
                        <Image src='/pictures/kwangtaikkim.jpg' alt="Kwang Taik Kim" className="rounded-full object-cover drop-shadow-lg m-5 w-52 h-52" width={1080} height={1080} />
                    </a >
                ...
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <a href="https://www.davidinouye.com/" target="_blank" rel="noopener noreferrer">
                        ...
                        <Image src='/pictures/davidinouye.jpg' alt="David Inouye" className="rounded-full object-cover drop-shadow-lg m-5 w-52 h-52" width={1080} height={1080} />
                    </a >
                ...
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <a href="https://www.princeton.edu/~pmittal/" target="_blank" rel="noopener noreferrer">
                        ...
                        <Image src='/pictures/prateekmittal.jpg' alt="Prateek Mittal" className="rounded-full object-cover drop-shadow-lg m-5 w-52 h-52" width={1080} height={1080} />
                    </a >
                ...
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    <a href="https://www.biostat.wisc.edu/~yli/" target="_blank" rel="noopener noreferrer">
                        <Image src='/pictures/yinli.jpg' alt="Yin Li" className="rounded-full object-cover drop-shadow-lg m-5 w-52 h-52" width={1080} height={1080} />
                    </a>
            ...
            <div className="flex flex-wrap justify-around">
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    ...
                    <Image src='/pictures/pengwang.jpg' alt="Peng Wang" className="rounded-full object-cover drop-shadow-lg m-5 w-52 h-52" width={1080} height={1080} />
                ...
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    ...
                    <Image src='/pictures/jameshare.jpg' alt="Zach Hare" className="rounded-full object-cover drop-shadow-lg m-5 w-52 h-52" width={1080} height={1080} />
                ...
                <div className="grid flex-col w-72 mb-5 place-content-center">
                    ...
                    <Image src='/pictures/kevinchan.jpg' alt="Kevin Chan" className="rounded-full object-cover drop-shadow-lg m-5 w-52 h-52" width={1080} height={1080} />
